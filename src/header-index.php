                                ...
                                <div class="main-header-menu">
                                    <nav class="desk-menu">
                                        <ul class="text-center">
                                            ...
                                            <li class="active"><a href="src/collection.php?type=bosuutap">bộ sưu tập</a>
                                            </li>
                                            <li class="active"><a class="active_3">sản phẩm&nbsp;<i
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    foreach ($cateName as $row) {
                                                        ...
                                                        ?>
                                                        <li><a
                                                                href="src/collection.php?type=<?php echo $row["tenloai"]; ?>">
                                                ...
                                                <form action="/src/search.php" class="search-scroll-form" method="get">
                                                    <div class="search-inner">
                                                        <input type="text" size="20" name="productName"
                                                            ...
                                                            oninput="showSearchScroll(),searchProductScroll(this.value)">
                                                    </div>
                                        ...
                                        <div class="site_panel login_scr">
                                            <div class="login_panels">
                                                ...
                                                <div class="account-list">
                                                    <form action="/controller/login.php" accept-charset="UTF-8"
                                                        ...
                                                        <button type="submit" class="form__submit"
                                                            id="form_submit-login" name="submitLogin">Đăng nhập</button>
                                                    </form>
                                        ...
                                        <div class="account-information info_scr hide">
                                            <div class="login_panel">
                                                ...
                                                <div class="account-list">
                                                    ...
                                                    <a href="">
                                                        <form action="/controller/logout.php" id="logout-form"
                                                            method="POST">
                                ...
                                <a class="header-action-toggle" aria-label="Giỏ Hàng" onclick="box_carts()">
                                    <span class="box-action-icon">
                                        ...
                                        <span class="count-holder">
                                            <span class="count">
                                                <?php echo $countProduct["count(makhachhang)"] ?>
                                            </span>
                                        </span>
                                    </span>
                                </a>
                                                                    ...
                                                                    foreach ($listProduct as $row) {
                                                                        if ($row["makhachhang"] == $_SESSION["userID"]) {
                                                                            ...
                                                                            <tr class="list-item">
                                                                                <td class="img">
                                                                                    <a
                                                                                        href="/src/product.php?type=<?php echo $row["masp"] ?>"><img
                                                                                            src="<?php echo $row["urlmain"] ?>"
                                                                                            alt=""></a>
                                                                                </td>
                                                                                <td class="information">
                                                                                    <a class="pro-title"
                                                                                        href="/src/product.php?type=<?php echo $row["masp"] ?>">
                                                                                        <?php echo $row["tensp"] ?>
                                                                                    </a>
                                                                                    <span class="variant">
                                                                                        <?php echo $row["mausac"] ?> &nbsp;/&nbsp;
                                                    ...
                                                    <table class="table-total">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="/src/cart.php">
                                                                        <button class="form__submit btn-view">Xem giỏ
                                                                            hàng</button>
                                                                    </a>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <a href="<?php if ($users["khoa"] == 1) {
                                                                        ...
                                                                        <button class=" form__submit btn-payment"
                ...
                <div class="flexContainer-header">
                    ...
                    <div class="wrapper-upper-search">
                        <div class="search-box">
                            <form accept-charset="UTF-8" action="/src/search.php" class="searchform" id="searchform"
                                method="get">
                                <div class="search-inner">
                                    <input required="" type="text" size="20" name="productName" id="productName"
                                        placeholder="Tìm kiếm sản phẩm..." class="searchInput"
                                        oninput="showSearch(),searchProduct(this.value)">
                                </div>
                    ...
                    <div class="wrapper-upper-icon">
                        <div class="header-wrap-icon">
                            <div class="header-action_account">
                                <a class="header-action-toggle" aria-label="Tài Khoản">
                                    ...
                                    <span class="icon-box-text " onclick="box_account()">
                                        ...
                                        <span class="txtAccount txtAccount_wrapper">Tài khoản của tôi &nbsp;&nbsp;<i
                                                class="icon_down fa fa-angle-down" aria-hidden="true"></i></span>
                                    </span>
                                </a>
                            ...
                            <div class="header-action_cart">
                                <a class="header-action-toggle" aria-label="Giỏ Hàng" onclick="box_cart()">
                                    <span class="box-action-icon">
                                        <i class="fa-light fa-cart-shopping"></i>
                                        <?php
                                        $count = $db->prepare("SELECT count(makhachhang) FROM `giohang` where makhachhang = :userID;");
                                ...
                                <div class="header_dropdown cart hide">
                                    ...
                                    <div class="site-nav">
                                        <div class="site-panel">
                                            <div class="cart_panel">
                                                <i class="fa-light fa-xmark" onclick="box_cart()"></i>
                                                <div class="cart-header">
                                                    <p>Giỏ hàng</p>
                                                </div>
                                            </div>
                                ...
                                <li class="active"><a class="active_3">sản phẩm&nbsp;<i
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        foreach ($cateName as $row) {
                                            ...
                                            ?>
                                            <li><a href="src/collection.php?type=<?php echo $row["tenloai"]; ?>">
                                                    <?php echo $row["tenloai"]; ?>
                                                </a></li>
...
<script>
    if (localStorage.getItem("khachhang") != null) {
        ...
        document.querySelector(".txtAccount_wrapper").innerHTML = JSON.parse(localStorage.getItem("khachhang")).name + "&nbsp;&nbsp;&nbsp;<i class=\"icon_down fa fa-angle-down\" aria-hidden=\"true\"></i>";
    } else {
